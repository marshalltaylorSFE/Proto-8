...
//
GenericLinkedList::GenericLinkedList( listIdemNumber_t inputNumber )
{
...
GenericLinkedList::GenericLinkedList( void )
{
...
void GenericLinkedList::pushObject( listObject_t & objectToPush )
{
...
void GenericLinkedList::dropObject( listIdemNumber_t positionToDrop )
{
...
void GenericLinkedList::insertObject( listObject_t & objectToInsert, listIdemNumber_t positionToBe )
{
	//pointer for object to drop
	listObject_t * tempObjectPtr;
...
//void GenericLinkedList::insertObjectByTime( listObject_t & objectToInsert )
//{
...
void GenericLinkedList::clear( void )
{
	//Drop it like it's NOT
...
//returns listObject_t
listObject_t * GenericLinkedList::readObject( listIdemNumber_t inputNumber ) //position 0 = top
{
  listObject_t * objectToReturn;
...
//listIdemNumber_t GenericLinkedList::seekNextAfter( uint32_t targetTicks )
//{
...
//int8_t GenericLinkedList::seekObjectbyTimeStamp( listObject_t & ) //pass listObject_t, returns position
//{
//	return 0;
//}

//int8_t GenericLinkedList::seekObjectbyNoteValue( listObject_t & noteToSeek ) //pass listObject_t, returns position
//{
...
listIdemNumber_t GenericLinkedList::listLength( void )
{
  return currentPosition;
}

//printfs the stack
void GenericLinkedList::printDebug( void )
{
