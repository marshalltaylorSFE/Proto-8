...
AudioSynthWaveformSine   sine1;          //xy=191,473
AudioSynthWaveformDcBinary dc_3_12;        //xy=201,400
AudioSynthWaveformDcBinary dc_centA;        //xy=338,526
AudioSynthWaveformDcBinary dc_centB;     //xy=351,565
AudioSynthWaveformDcBinary dc_centC;     //xy=359,606
AudioSynthWaveformDcBinary dc_centD;     //xy=372,647
AudioMixer4              mixer1;         //xy=381,429
AudioSynthWaveformDcBinary dc_amplitude;   //xy=382,341
AudioSynthMultiOsc       multiosc1;      //xy=626,480
AudioSynthWaveformDcBinary dc_out_volume;  //xy=632,644
AudioEffectMultiply      multiply1;      //xy=860,538
AudioOutputI2S           i2s1;           //xy=1014,495
AudioOutputAnalog        dac1;           //xy=1017,578
AudioConnection          patchCord1(sine1, 0, mixer1, 1);
AudioConnection          patchCord2(dc_3_12, 0, mixer1, 0);
AudioConnection          patchCord3(dc_centA, 0, multiosc1, 2);
AudioConnection          patchCord4(dc_centB, 0, multiosc1, 4);
AudioConnection          patchCord5(dc_centC, 0, multiosc1, 6);
AudioConnection          patchCord6(dc_centD, 0, multiosc1, 8);
AudioConnection          patchCord7(mixer1, 0, multiosc1, 1);
AudioConnection          patchCord8(mixer1, 0, multiosc1, 3);
AudioConnection          patchCord9(mixer1, 0, multiosc1, 5);
AudioConnection          patchCord10(mixer1, 0, multiosc1, 7);
AudioConnection          patchCord11(dc_amplitude, 0, multiosc1, 0);
AudioConnection          patchCord12(multiosc1, 0, multiply1, 0);
AudioConnection          patchCord13(dc_out_volume, 0, multiply1, 1);
AudioConnection          patchCord14(multiply1, 0, i2s1, 0);
AudioConnection          patchCord15(multiply1, dac1);
AudioConnection          patchCord16(multiply1, 0, i2s1, 1);
AudioControlSGTL5000     sgtl5000_1;     //xy=1003,436
...
void setup() {
	...
	dc_centA.amplitude_int(1);
	dc_centB.amplitude_int(1);
	dc_centC.amplitude_int(1);
	dc_centD.amplitude_int(1);
	...
	testWave.setParameters( 255, 50, 255, 0, 45 );			
...
void loop() {
	...
	if (millis() >= next)
	{
		...
		if( (lastKnob5Value) != (newKnob5Value) )
		{
			...
			dc_centA.amplitude_int(((int32_t)(newKnob5Value + 1)<<6) - 0x7FFF);
			dc_centB.amplitude_int(((int32_t)(newKnob5Value - 2)<<6) - 0x7FFF);
			dc_centC.amplitude_int(((int32_t)(newKnob5Value + 8)<<6) - 0x7FFF);
			dc_centD.amplitude_int(((int32_t)(newKnob5Value - 7)<<6) - 0x7FFF);
		}
